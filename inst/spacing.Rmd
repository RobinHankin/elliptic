...
in $+1$ and $1+1$.  It is in fact quite difficult to convince TeX to
typeset copy such as the chess "win, draw, loss" notation [something
like "$\mathord{+}3\ \mathord{=}4\ \mathord{-}5$", which would mean 3
wins, 4 draws and 5 losses.  The difficulty is persuading TeX to treat
the equals sign and the minus sign as unary operators].
