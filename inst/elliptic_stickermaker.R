...
plot(P(z=solid.lines,params=p),xlim=c(-4,4),ylim=c(-6,3),type="l",lwd=7,asp=1,axes=FALSE,xlab="",ylab="")
lines(P(z=dotted.lines,params=p),xlim=c(-4,4),ylim=c(-6,0),type="l",lty=2,lwd=7)
dev.off()




sticker("elliptic_icon.png", package="elliptic", p_size=8, s_x=0.975, s_y=0.8,
